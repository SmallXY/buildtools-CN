...
public class Builder
{
    ...
    public static void startBuilder(String[] args, OptionSet options) throws Exception
    {
        ...
        System.out.println( "加载的编译工具的版本: " + buildVersion + " (#" + buildNumber + ")" );
        System.out.println( "Java版本: " + JavaVersion.getCurrentVersion() );
        System.out.println( "当前路径: " + CWD.getCanonicalPath() );
